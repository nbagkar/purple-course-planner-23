  ...
  return (
    <header className="w-full bg-gradient-to-br from-primary/20 via-primary/10 to-transparent border-b border-primary/20 py-12">
      <div className="container mx-auto px-4">
        ...
        <h1 className="text-3xl md:text-4xl font-bold tracking-tight text-foreground max-w-3xl bg-gradient-to-br from-foreground to-foreground/70 bg-clip-text text-transparent">
